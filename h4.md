...
-  Firefox addons creator Eric Jung (https://addons.mozilla.org/en-US/firefox/user/323/)
-  Eric Jung homepage (https://ericjung.net/)
-  Foxy Proxy addons sivu (https://addons.mozilla.org/en-US/firefox/addon/foxyproxy-standard/)
