...
_________________________________________________
## c) Asenna John the Ripper ja testaa sen toiminta murtamalla jonkin esimerkkitiedoston salasana. [Aiemmasta raportista](https://github.com/SamiYli/Tunkeutumistestaus/blob/main/h7.md?plain=1)
...
![cat gpg2john](imagesh5/gpg2john2.JPG)
...
John the ripper packages: FLATPACK (https://github.com/openwall/john-packages/blob/main/readme.md)
OMP ilmeisesti viittaa OpenMP:hen. Tämä on siis Multi-Processing ja kertoo, että build tukee Ydinten välistä tai säikeiden välille jaettua laskentaa. OpenCL olisi näytönohjainlaskentaan.
...
- John the ripper github, packages: FLATPACK (https://github.com/openwall/john-packages/blob/main/readme.md) (Luettu 22.9.2026)
